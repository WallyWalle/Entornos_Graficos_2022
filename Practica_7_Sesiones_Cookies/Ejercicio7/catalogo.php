...
$link = mysqli_connect("localhost", "root", "password") or die ("Problemas de
...
title="Ver el contenido del carrito"><img src="vercarrito.gif" width="75" height="75"
border="0"></a></td>
 </tr>
 <?php
 ...
 $carro[md5($row['id'])]['identificador']!=md5($row['id'])){
  ...
  ?>"><img src="productonoagregado.gif" width="50" height="50" border="0" title="Agregar al
  Carrito"></a><?php }
   else
   {?><a href="borrarcar.php?<?php echo SID ?>&id=<?php echo $row['id'];
    ?>"><img src="productoagregado.gif" border="0" width="50" height="50" title="Quitar del Carrito"></a><?php
    } ?></td>
     </tr><?php } ?>
    </table>
    </body>
